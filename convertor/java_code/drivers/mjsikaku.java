...
public class mjsikaku
{
	...
	public static GameDriver driver_mjsikaku	   = new GameDriver("1988"	,"mjsikaku"	,"mjsikaku.java"	,rom_mjsikaku,null	,machine_driver_mjsikaku	,input_ports_mjsikaku	,init_mjsikaku	,ROT0_16BIT	,	"Nichibutsu", "Mahjong Sikaku (Japan set 1)", GAME_NO_COCKTAIL)
	public static GameDriver driver_mjsikakb	   = new GameDriver("1988"	,"mjsikakb"	,"mjsikaku.java"	,rom_mjsikakb,driver_mjsikaku	,machine_driver_mjsikaku	,input_ports_mjsikaku	,init_mjsikaku	,ROT0_16BIT	,	"Nichibutsu", "Mahjong Sikaku (Japan set 2)", GAME_NO_COCKTAIL)
	public static GameDriver driver_otonano	   = new GameDriver("1988"	,"otonano"	,"mjsikaku.java"	,rom_otonano,null	,machine_driver_otonano	,input_ports_otonano	,init_otonano	,ROT0_16BIT	,	"Apple", "Otona no Mahjong (Japan)", GAME_NO_COCKTAIL)
	public static GameDriver driver_mjcamera	   = new GameDriver("1988"	,"mjcamera"	,"mjsikaku.java"	,rom_mjcamera,null	,machine_driver_mjcamera	,input_ports_mjcamera	,init_mjcamera	,ROT0_16BIT	,	"MIKI SHOJI", "Mahjong Camera Kozou (Japan)", GAME_NO_COCKTAIL)
	public static GameDriver driver_secolove	   = new GameDriver("1986"	,"secolove"	,"mjsikaku.java"	,rom_secolove,null	,machine_driver_secolove	,input_ports_secolove	,init_secolove	,ROT0_16BIT	,	"Nichibutsu", "Second Love (Japan)", GAME_NO_COCKTAIL | GAME_WRONG_COLORS)
	public static GameDriver driver_citylove	   = new GameDriver("1986"	,"citylove"	,"mjsikaku.java"	,rom_citylove,null	,machine_driver_citylove	,input_ports_citylove	,init_citylove	,ROT0_16BIT	,	"Nichibutsu", "City Love (Japan)", GAME_NO_COCKTAIL | GAME_WRONG_COLORS)
	public static GameDriver driver_seiha	   = new GameDriver("1987"	,"seiha"	,"mjsikaku.java"	,rom_seiha,null	,machine_driver_seiha	,input_ports_seiha	,init_seiha	,ROT0_16BIT	,	"Nichibutsu", "Seiha (Japan)", GAME_NO_COCKTAIL | GAME_WRONG_COLORS)
	public static GameDriver driver_seiham	   = new GameDriver("1987"	,"seiham"	,"mjsikaku.java"	,rom_seiham,driver_seiha	,machine_driver_seiham	,input_ports_seiham	,init_seiham	,ROT0_16BIT	,	"Nichibutsu", "Seiha [BET] (Japan)", GAME_NO_COCKTAIL | GAME_WRONG_COLORS)
	public static GameDriver driver_iemoto	   = new GameDriver("1987"	,"iemoto"	,"mjsikaku.java"	,rom_iemoto,null	,machine_driver_iemoto	,input_ports_iemoto	,init_iemoto	,ROT0_16BIT	,	"Nichibutsu", "Iemoto (Japan)", GAME_NO_COCKTAIL | GAME_WRONG_COLORS)
	public static GameDriver driver_ojousan	   = new GameDriver("1987"	,"ojousan"	,"mjsikaku.java"	,rom_ojousan,null	,machine_driver_ojousan	,input_ports_ojousan	,init_ojousan	,ROT0_16BIT	,	"Nichibutsu", "Ojousan (Japan)", GAME_NO_COCKTAIL | GAME_WRONG_COLORS)
	public static GameDriver driver_bijokkoy	   = new GameDriver("1987"	,"bijokkoy"	,"mjsikaku.java"	,rom_bijokkoy,null	,machine_driver_bijokkoy	,input_ports_bijokkoy	,init_bijokkoy	,ROT0_16BIT	,	"Nichibutsu", "Bijokko Yume Monogatari (Japan)", GAME_NO_COCKTAIL | GAME_WRONG_COLORS)
	public static GameDriver driver_bijokkog	   = new GameDriver("1988"	,"bijokkog"	,"mjsikaku.java"	,rom_bijokkog,null	,machine_driver_bijokkog	,input_ports_bijokkog	,init_bijokkog	,ROT0_16BIT	,	"Nichibutsu", "Bijokko Gakuen (Japan)", GAME_NO_COCKTAIL | GAME_WRONG_COLORS)
	public static GameDriver driver_housemnq	   = new GameDriver("1987"	,"housemnq"	,"mjsikaku.java"	,rom_housemnq,null	,machine_driver_housemnq	,input_ports_housemnq	,init_housemnq	,ROT0_16BIT	,	"Nichibutsu", "House Mannequin (Japan)", GAME_NO_COCKTAIL | GAME_WRONG_COLORS | GAME_NOT_WORKING)
	public static GameDriver driver_housemn2	   = new GameDriver("1987"	,"housemn2"	,"mjsikaku.java"	,rom_housemn2,null	,machine_driver_housemn2	,input_ports_housemn2	,init_housemn2	,ROT0_16BIT	,	"Nichibutsu", "House Mannequin Roppongi Live hen (Japan)", GAME_NO_COCKTAIL | GAME_WRONG_COLORS | GAME_NOT_WORKING)
	public static GameDriver driver_kaguya	   = new GameDriver("1988"	,"kaguya"	,"mjsikaku.java"	,rom_kaguya,null	,machine_driver_kaguya	,input_ports_kaguya	,init_kaguya	,ROT0_16BIT	,	"MIKI SHOJI", "Mahjong Kaguyahime [BET] (Japan)", GAME_NO_COCKTAIL)
	public static GameDriver driver_crystal2	   = new GameDriver("1986"	,"crystal2"	,"mjsikaku.java"	,rom_crystal2,null	,machine_driver_crystal2	,input_ports_crystal2	,init_crystal2	,ROT0	,	"Nichibutsu", "Crystal Gal 2 (Japan)", GAME_NO_COCKTAIL)
	public static GameDriver driver_apparel	   = new GameDriver("1986"	,"apparel"	,"mjsikaku.java"	,rom_apparel,null	,machine_driver_apparel	,input_ports_apparel	,init_apparel	,ROT0	,	"Central Denshi", "Apparel Night (Japan)", GAME_NO_COCKTAIL)
}
