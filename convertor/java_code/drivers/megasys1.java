...
public class megasys1
{
	...
	*/
	...
	{
		if (ACCESSING_LSB != 0)	YM2151_register_port_0_w(0, data & 0xff);
	}
	
	WRITE16_HANDLER( YM2151_data_port_0_lsb_w )
	{
		if (ACCESSING_LSB != 0)	YM2151_data_port_0_w(0, data & 0xff);
	}
	...
	***************************************************************************/
	...
	( \
		...
		new int[] { MIXER(30,MIXER_PAN_LEFT), MIXER(30,MIXER_PAN_RIGHT) } \
	); \
	 \
	...
	***************************************************************************/
	...
	public static GameDriver driver_hachoo	   = new GameDriver("1989"	,"hachoo"	,"megasys1.java"	,rom_hachoo,null	,machine_driver_hachoo	,input_ports_hachoo	,init_hachoo	,ROT0	,	"Jaleco", "Hachoo!", GAME_IMPERFECT_SOUND )
