...
public class harddriv
{
	...
	static MachineDriver machine_driver_harddriv = new MachineDriver
	(
		...
		new MachineCPU[] {
			...
			new MachineCPU(
				...
				gsp_readmem_1mb,gsp_writemem_1mb,null,null,
				ignore_interrupt,1,
				null,null,gsp_config
			),
			new MachineCPU(
				CPU_TMS34010,
				50000000/TMS34010_CLOCK_DIVIDER,
				msp_readmem,msp_writemem,null,null,
				ignore_interrupt,1,
				null,null,msp_config
			),
			new MachineCPU(
				CPU_ADSP2100,
				8000000,
				adsp_readmem,adsp_writemem,null,null,
				ignore_interrupt,1
			),
	/*		new MachineCPU(
				CPU_M68000 | CPU_AUDIO_CPU,
				16000000/2,
				snd_main_readmem,snd_main_writemem,null,null,
				ignore_interrupt,1
			),
			new MachineCPU(
	...
	static MachineDriver machine_driver_racedriv = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
			...
			new MachineCPU(
				CPU_TMS34010,
				48000000/TMS34010_CLOCK_DIVIDER,
				gsp_readmem_512k,gsp_writemem_512k,null,null,
				ignore_interrupt,1,
				null,null,gsp_config
			),
			new MachineCPU(
	...
	/*		new MachineCPU(
				CPU_DSP32,
				40000000/4,
				dsp32_readmem,dsp32_readmem,null,null,
				ignore_interrupt,1
			),
		new MachineCPU(
				CPU_M68000 | CPU_AUDIO_CPU,
	...
	static MachineDriver machine_driver_stunrun = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
	...
	static MachineDriver machine_driver_steeltal = new MachineDriver
	(
		/* basic machine hardware */
		new MachineCPU[] {
			new MachineCPU(
			...
			new MachineCPU(
				CPU_ADSP2105,
				12000000,
				ds3_readmem,ds3_writemem,null,null,
				ignore_interrupt,1
			),
			JSA_III_CPU
		},
	...
	*/
	...
	public static GameDriver driver_harddriv	   = new GameDriver("1988"	,"harddriv"	,"harddriv.java"	,rom_harddriv,null	,machine_driver_harddriv	,input_ports_harddriv	,init_harddriv	,ROT0_16BIT	,	"Atari Games", "Hard Drivin'", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_stunrun	   = new GameDriver("1989"	,"stunrun"	,"harddriv.java"	,rom_stunrun,null	,machine_driver_stunrun	,input_ports_stunrun	,init_stunrun	,ROT0_16BIT	,	"Atari Games", "S.T.U.N. Runner" )
	public static GameDriver driver_stunrnp	   = new GameDriver("1989"	,"stunrnp"	,"harddriv.java"	,rom_stunrnp,driver_stunrun	,machine_driver_stunrun	,input_ports_stunrun	,init_stunrun	,ROT0_16BIT	,	"Atari Games", "S.T.U.N. Runner (Prototype)" )
	public static GameDriver driver_racedriv	   = new GameDriver("1990"	,"racedriv"	,"harddriv.java"	,rom_racedriv,null	,machine_driver_harddriv	,input_ports_racedriv	,init_racedriv	,ROT0_16BIT	,	"Atari Games", "Race Drivin' (Upgrade)", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_racedrvc	   = new GameDriver("1990"	,"racedrvc"	,"harddriv.java"	,rom_racedrvc,driver_racedriv	,machine_driver_racedriv	,input_ports_racedriv	,init_racedrvc	,ROT0_16BIT	,	"Atari Games", "Race Drivin' (Compact)", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_steeltal	   = new GameDriver("1990"	,"steeltal"	,"harddriv.java"	,rom_steeltal,null	,machine_driver_steeltal	,input_ports_steeltal	,init_steeltal	,ROT0_16BIT	,	"Atari Games", "Steel Talons", GAME_NOT_WORKING )
	public static GameDriver driver_steeltdb	   = new GameDriver("1990"	,"steeltdb"	,"harddriv.java"	,rom_steeltdb,driver_steeltal	,machine_driver_steeltal	,input_ports_steeltal	,init_steeltal	,ROT0_16BIT	,	"Atari Games", "Steel Talons (debug)", GAME_NOT_WORKING )
	public static GameDriver driver_hdrivair	   = new GameDriver("1993"	,"hdrivair"	,"harddriv.java"	,rom_hdrivair,null	,machine_driver_steeltal	,input_ports_hdrivair	,init_hdrivair	,ROT0_16BIT	,	"Atari Games", "Hard Drivin's Airborne (Prototype)", GAME_NOT_WORKING )
	public static GameDriver driver_hdrivaip	   = new GameDriver("1993"	,"hdrivaip"	,"harddriv.java"	,rom_hdrivaip,driver_hdrivair	,machine_driver_steeltal	,input_ports_hdrivair	,init_hdrivair	,ROT0_16BIT	,	"Atari Games", "Hard Drivin's Airborne (Prototype, early rev)", GAME_NOT_WORKING )
}
