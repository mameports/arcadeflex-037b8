...
public class bjtwin
{
	...
	*/
	...
	(
		...
		new int[] { 25 },	/* volume */
		new WriteYmHandlerPtr[] { mustang_ym3812_irqhandler },
	);
	...
	(
		...
		new WriteHandlerPtr[] { 0 },
		new WriteYmHandlerPtr[] { ym2203_irqhandler }
	);
	
	static OKIM6295interface okim6295_interface_single = new OKIM6295interface
	(
		1,              	/* 1 chip */
		new int[] { 16000000/4/165 },	/* 24242Hz frequency? */
	...
	(
		2,              					/* 2 chips */
		new int[] { 16000000/4/165, 16000000/4/165 },	/* 24242Hz frequency? */
	...
	(
		...
		new MachineCPU[] {
			...
			new MachineCPU(
				...
				4000000, /* 4 MHz ? */
				mustang_sound_readmem,mustang_sound_writemem,null,null,
				ignore_interrupt,1
			)
		},
	...
	public static GameDriver driver_mustang	   = new GameDriver("1990"	,"mustang"	,"bjtwin.java"	,rom_mustang,null	,machine_driver_mustang	,input_ports_mustang	,null	,ROT0	,	"UPL", "US AAF Mustang", GAME_UNEMULATED_PROTECTION | GAME_NO_SOUND )
	public static GameDriver driver_acrobatm	   = new GameDriver("1991"	,"acrobatm"	,"bjtwin.java"	,rom_acrobatm,null	,machine_driver_acrobatm	,input_ports_hachamf	,init_acrobatm	,ROT270	,	"UPL (Taito license)", "Acrobat Mission", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_bioship	   = new GameDriver("1991?"	,"bioship"	,"bjtwin.java"	,rom_bioship,null	,machine_driver_bioship	,input_ports_hachamf	,init_bioship	,ROT0	,	"UPL (American Sammy license)", "Bio-ship Paladin", GAME_NO_SOUND )
	...
	public static GameDriver driver_strahl	   = new GameDriver("1992"	,"strahl"	,"bjtwin.java"	,rom_strahl,null	,machine_driver_strahl	,input_ports_hachamf	,init_strahl	,ROT0	,	"UPL", "Strahl", GAME_NO_SOUND )
	...
	public static GameDriver driver_macross2	   = new GameDriver("1993"	,"macross2"	,"bjtwin.java"	,rom_macross2,null	,machine_driver_macross2	,input_ports_macross	,null	,ROT0	,	"Banpresto", "Macross II", GAME_NO_COCKTAIL )
