...
public class cps1
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_sf2i = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1 );     /* 68000 code */
	...
	public static GameDriver driver_sf2i	   = new GameDriver("1991"	,"sf2i"	,"cps1.java"	,rom_sf2i,driver_sf2	,machine_driver_sf2	,input_ports_sf2	,null	,ROT0	,	"Capcom", "Street Fighter II - The World Warrior (US 910522)" )
	...
	public static GameDriver driver_pnickj	   = new GameDriver("1994"	,"pnickj"	,"cps1.java"	,rom_pnickj,null	,machine_driver_cps1	,input_ports_pnickj	,null	,ROT0	,	"Compile (Capcom license)", "Pnickies (Japan)" )
