...
public class rampart
{
	...
	public static GameDriver driver_rampart	   = new GameDriver("1990"	,"rampart"	,"rampart.java"	,rom_rampart,null	,machine_driver_rampart	,input_ports_rampart	,init_rampart	,ROT0	,	"Atari Games", "Rampart (3-player Trackball)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_ramprt2p	   = new GameDriver("1990"	,"ramprt2p"	,"rampart.java"	,rom_ramprt2p,driver_rampart	,machine_driver_rampart	,input_ports_ramprt2p	,init_rampart	,ROT0	,	"Atari Games", "Rampart (2-player Joystick)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_rampartj	   = new GameDriver("1990"	,"rampartj"	,"rampart.java"	,rom_rampartj,driver_rampart	,machine_driver_rampart	,input_ports_ramprt2p	,init_rampart	,ROT0	,	"Atari Games", "Rampart (Japan, 2-player Joystick)", GAME_UNEMULATED_PROTECTION )
}
