...
public class drawgfx
{
	...
	***************************************************************************/
	...
	public static plot_pixel_procPtr pp_8_d  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[y][x] = p; osd_mark_dirty(x,y,x,y); } };
	public static plot_pixel_procPtr pp_8_d_fx  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.width-1-x;  b.line[y][x] = p; osd_mark_dirty(x,y,x,y); } };
	public static plot_pixel_procPtr pp_8_d_fy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { y = b.height-1-y; b.line[y][x] = p; osd_mark_dirty(x,y,x,y); } };
	public static plot_pixel_procPtr pp_8_d_fxy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.width-1-x; y = b.height-1-y; b.line[y][x] = p; osd_mark_dirty(x,y,x,y); } };
	public static plot_pixel_procPtr pp_8_d_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[x][y] = p; osd_mark_dirty(y,x,y,x); } };
	public static plot_pixel_procPtr pp_8_d_fx_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { y = b.width-1-y; b.line[x][y] = p; osd_mark_dirty(y,x,y,x); } };
	public static plot_pixel_procPtr pp_8_d_fy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.height-1-x; b.line[x][y] = p; osd_mark_dirty(y,x,y,x); } };
	public static plot_pixel_procPtr pp_8_d_fxy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.height-1-x; y = b.width-1-y; b.line[x][y] = p; osd_mark_dirty(y,x,y,x); } };
	...
	public static plot_pixel_procPtr pp_16_d  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[y])[x] = p; osd_mark_dirty(x,y,x,y); } };
	public static plot_pixel_procPtr pp_16_d_fx  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.width-1-x;  ((UINT16 *)b.line[y])[x] = p; osd_mark_dirty(x,y,x,y); } };
	public static plot_pixel_procPtr pp_16_d_fy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { y = b.height-1-y; ((UINT16 *)b.line[y])[x] = p; osd_mark_dirty(x,y,x,y); } };
	public static plot_pixel_procPtr pp_16_d_fxy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.width-1-x; y = b.height-1-y; ((UINT16 *)b.line[y])[x] = p; osd_mark_dirty(x,y,x,y); } };
	public static plot_pixel_procPtr pp_16_d_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[x])[y] = p; osd_mark_dirty(y,x,y,x); } };
	public static plot_pixel_procPtr pp_16_d_fx_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { y = b.width-1-y; ((UINT16 *)b.line[x])[y] = p; osd_mark_dirty(y,x,y,x); } };
	public static plot_pixel_procPtr pp_16_d_fy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.height-1-x; ((UINT16 *)b.line[x])[y] = p; osd_mark_dirty(y,x,y,x); } };
	public static plot_pixel_procPtr pp_16_d_fxy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.height-1-x; y = b.width-1-y; ((UINT16 *)b.line[x])[y] = p; osd_mark_dirty(y,x,y,x); } };
	...
	public static plot_box_procPtr pb_8_d  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; osd_mark_dirty(t,y,t+w-1,y+h-1); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_8_d_fx  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x;  osd_mark_dirty(t-w+1,y,t,y+h-1); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_8_d_fy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->height-1-y; osd_mark_dirty(t,y-h+1,t+w-1,y); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_8_d_fxy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x; y = b->height-1-y; osd_mark_dirty(t-w+1,y-h+1,t,y); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x--; } y--; } } };
	public static plot_box_procPtr pb_8_d_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; osd_mark_dirty(y,t,y+h-1,t+w-1); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_8_d_fx_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->width-1-y;  osd_mark_dirty(y-h+1,t,y,t+w-1); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_8_d_fy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; osd_mark_dirty(y,t-w+1,y+h-1,t); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_8_d_fxy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; y = b->width-1-y; osd_mark_dirty(y-h+1,t-w+1,y,t); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x--; } y--; } } };
	...
	public static plot_box_procPtr pb_16_d  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; osd_mark_dirty(t,y,t+w-1,y+h-1); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_16_d_fx  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x;  osd_mark_dirty(t-w+1,y,t,y+h-1); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_16_d_fy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->height-1-y; osd_mark_dirty(t,y-h+1,t+w-1,y); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_16_d_fxy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x; y = b->height-1-y; osd_mark_dirty(t-w+1,y-h+1,t,y); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x--; } y--; } } };
	public static plot_box_procPtr pb_16_d_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; osd_mark_dirty(y,t,y+h-1,t+w-1); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_16_d_fx_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->width-1-y; osd_mark_dirty(y-h+1,t,y,t+w-1); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_16_d_fy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; osd_mark_dirty(y,t-w+1,y+h-1,t); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_16_d_fxy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; y = b->width-1-y; osd_mark_dirty(y-h+1,t-w+1,y,t); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x--; } y--; } } };
