...
INLINE void addr_r( void )
{
	...
	switch(tb>>4) {
		...
		case 10: if (promote != 0) src16Reg = &z16; else src8Reg = &CC; break; /* I dont know if this is the correct promotion */
		case 11: if (promote != 0) src16Reg = &z16; else src8Reg = &DP; break; /* I dont know if this is the correct promotion */
	...
	switch(tb&15) {
		...
		case 10: if (promote != 0) dst16Reg = &z16; else dst8Reg = &CC; break; /* I dont know if this is the correct promotion */
		case 11: if (promote != 0) dst16Reg = &z16; else dst8Reg = &DP; break; /* I dont know if this is the correct promotion */
...
static UBytePtr 	regTable[4] = { &(CC), &(A), &(B), &(E) };
