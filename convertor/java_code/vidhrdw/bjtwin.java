...
public class bjtwin
{
	...
	***************************************************************************/
	...
	public static GetTileInfoPtr macross_get_bg_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int code = nmk_bgvideoram[tile_index];
		SET_TILE_INFO(1,(code & 0xfff) + (bgbank << 12),code >> 12)
	} };
	
	public static GetTileInfoPtr strahl_get_fg_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int code = nmk_fgvideoram[tile_index];
		SET_TILE_INFO(3,(code & 0xfff),code >> 12)
	} };
	
	public static GetTileInfoPtr macross_get_tx_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int code = nmk_txvideoram[tile_index];
		SET_TILE_INFO(0,code & 0xfff,code >> 12)
	} };
	
	public static GetTileInfoPtr bjtwin_get_bg_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		int code = nmk_bgvideoram[tile_index];
	...
	***************************************************************************/
	...
	public static VhStopPtr nmk_vh_stop = new VhStopPtr() { public void handler() 
	{
		...
		spriteram_old = NULL;
		spriteram_old2 = NULL;
		if (background_bitmap != 0) bitmap_free(background_bitmap);
	} };
	...
	***************************************************************************/
	...
	public static VhUpdatePtr bioship_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		data16_t *tilerom = (data16_t *)memory_region(REGION_USER1);
	...
	public static VhUpdatePtr strahl_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		tilemap_set_scrollx(tx_tilemap,0,-videoshift);
	...
	public static VhEofCallbackPtr nmk_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
