...
public class m72
{
	...
	***************************************************************************/
	...
	INLINE void m72_get_tile_info(int tile_index,UBytePtr videoram,int gfxnum)
	{
	...
	INLINE void rtype2_get_tile_info(int tile_index,UBytePtr videoram,int gfxnum)
	{
		int code,attr,color,pri;
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr rtype2_port02_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		if ((data & 0xf0) != 0) logerror("write %02x to port 02\n",data);
