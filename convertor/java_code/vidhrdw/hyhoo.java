...
public class hyhoo
{
	...
	public static VhUpdatePtr hyhoo_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y;
