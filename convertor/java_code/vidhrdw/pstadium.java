...
public class pstadium
{
	...
	static UBytePtr pstadium_videoram;
	...
	static void pstadium_calc_scrollx(void)
	{
		...
		if ((pstadium_dispflag & 0x04) != 0) pstadium_scrollx = 0x00;	// for now
	}
	...
	public static VhUpdatePtr pstadium_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y;
		int color;
	...
	public static VhUpdatePtr galkoku_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y;
		int color;
