...
public class mjsikaku
{
	...
	/******************************************************************/
	public static VhConvertColorPromPtr mjsikaku_init_palette = new VhConvertColorPromPtr() { public void handler(char []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	public static VhConvertColorPromPtr secolove_init_palette = new VhConvertColorPromPtr() { public void handler(char []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	public static VhConvertColorPromPtr seiha_init_palette = new VhConvertColorPromPtr() { public void handler(char []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	public static VhConvertColorPromPtr crystal2_init_palette = new VhConvertColorPromPtr() { public void handler(char []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	static void mjsikaku_gfxdraw(void)
	{
		...
		if ((mjsikaku_dispflag2 & 0x20) != 0) return;
	...
	public static VhStartPtr housemnq_vh_start = new VhStartPtr() { public int handler() 
	{
		if ((tmpbitmap1 = bitmap_alloc(Machine.drv.screen_width, Machine.drv.screen_height)) == 0) return 1;
		if ((mjsikaku_videoram = malloc(Machine.drv.screen_width * Machine.drv.screen_height * sizeof(short))) == 0) return 1;
		memset(mjsikaku_videoram, 0x0000, (Machine.drv.screen_width * Machine.drv.screen_height * sizeof(short)));
	...
	public static VhUpdatePtr mjsikaku_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y;
