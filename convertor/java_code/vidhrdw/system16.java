	...
	*/
	...
	public static VhUpdatePtr sys16_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) {
		...
		if(!sys16_quartet_title_kludge)
		{
			...
			if (sys16_bg_priority_mode != 0) tilemap_draw( bitmap, background, TILEMAP_IGNORE_TRANSPARENCY | 1 ,0);
		}
		else
	...
	public static VhUpdatePtr sys18_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) {
		...
		if (sys18_fg2_active != 0) tilemap_draw( bitmap, foreground2, 0 ,0);
		tilemap_draw( bitmap, foreground, 0 ,0);
		sprite_draw(sprite_list,1);
		if (sys18_fg2_active != 0) tilemap_draw( bitmap, foreground2, 1 ,0);
		tilemap_draw( bitmap, foreground, 1 ,0);
