	...
	***************************************************************************/
	...
	if (keyboard_pressed(KEYCODE_Z))
	{
		...
		if ((order & 1) != 0)	// swap the layers?
		{
			if (tilemap_2 != 0)
			{
				if ((layers_ctrl & 2) != 0)	tilemap_draw(bitmap, tilemap_2, TILEMAP_IGNORE_TRANSPARENCY,0);
				if ((layers_ctrl & 2) != 0)	tilemap_draw(bitmap, tilemap_3, TILEMAP_IGNORE_TRANSPARENCY,0);
			}
			...
			if ((order & 2) != 0)	// layer-sprite priority?
			{
				...
				if ((layers_ctrl & 1) != 0)	tilemap_draw(bitmap, tilemap_1,  0,0);
			}
			else
			{
				if ((layers_ctrl & 1) != 0)	tilemap_draw(bitmap, tilemap_0,  0,0);
		...
		else
		{
			...
			if ((layers_ctrl & 1) != 0)	tilemap_draw(bitmap, tilemap_1,  TILEMAP_IGNORE_TRANSPARENCY,0);
			...
			if ((order & 2) != 0)	// layer-sprite priority?
			{
				...
				if (tilemap_2 != 0)
				{
					if ((layers_ctrl & 2) != 0)	tilemap_draw(bitmap, tilemap_2,  0,0);
					if ((layers_ctrl & 2) != 0)	tilemap_draw(bitmap, tilemap_3,  0,0);
				}
			}
			else
			{
