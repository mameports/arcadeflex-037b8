...
public class iremga20
{
	...
	void IremGA20_update( int param, INT16 **buffer, int length )
	{
		...
		UBytePtr rom=memory_region(IremGA20_chip.intf.region);
	...
	public static ShStartPtr IremGA20_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		const char *names[2];
		char ch_names[2][40];
		int i;
	...
	public static ShStopPtr IremGA20_sh_stop = new ShStopPtr() { public void handler() 
	{
	} };
