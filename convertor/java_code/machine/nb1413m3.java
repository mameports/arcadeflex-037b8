...
public class nb1413m3
{
	...
	public static nvramPtr nb1413m3_nvram_handler  = new nvramPtr() { public void handler(Object file, int read_or_write) 
	{
		if (read_or_write != 0)
	...
	{
		UBytePtr SNDROM = memory_region(REGION_SOUND1);
		int rombank;
		int ret;
	...
	{
		UBytePtr GFXROM = memory_region(REGION_GFX1);
	...
	{
		if ((data & 0x08) != 0) usrintf_showmessage(" ** VCR CONTROL ** ");
	}
}
